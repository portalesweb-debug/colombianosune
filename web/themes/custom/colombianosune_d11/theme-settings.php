 ...
 */
function colombianosune_d11_form_system_theme_settings_alter(&$form, FormStateInterface $form_state) {
  ...
  $form['colors']['scheme']['bootstrap_enable_color'] = [
    ...
    '#ajax' => [
      'callback' => 'colombianosune_d11_colorCallback',
...
/**
 * Color scheme callback for colombianosune_d11 theme.
 *
 * @param $form
 * @param FormStateInterface $form_state
 * @return mixed
 */
function colombianosune_d11_colorCallback($form, FormStateInterface $form_state)
{
